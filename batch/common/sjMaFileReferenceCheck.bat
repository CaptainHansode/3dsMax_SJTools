...
//
    ...
    //----------------------------------------------------------------
    //
    //	@bref	arrayにfindプロパティを追加
    //	@array	array or dictiona
    //
...
//	}
    ...
    //----------------------------------------------------------------
    //
    //	@bref		Mayaのリファレンスがあるか？
    //	@ma_file	ma_file
    //	@return		問題のあったファイルリスト
    //
...
//			}
    ...
    //	@return	なし
    //
    function lookDisckey(dictionary)
    {
        for (var key in dictionary) {
            print(key);
        }
